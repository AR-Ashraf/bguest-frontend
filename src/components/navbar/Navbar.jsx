...
import {ROOT, LOGIN, OVERVIEW, PRICING, DASHBOARD} from "../../helpers/Constants";
  ...
  return (
    <div className="bguest__navbar">
        ...
        <div className="bguest__navbar-menu">
          ...
          ?
          <NavLink to={DASHBOARD} preventScrollReset={true} activeClassName="active">Dashboard</NavLink>
          :
